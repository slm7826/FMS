...
contains
  ...
  procedure(most_integral_function),   deferred :: integral_m
  procedure(most_integral_function),   deferred :: integral_t
  procedure(most_integral_function),   deferred :: integral_q
